...
public class CustomSelectActivity extends AppCompatActivity implements MaterialSearchView.OnQueryTextListener {
    ...
    /**
     * Funcion que se ejecuta para crear la pantalla
